...
#ifndef KBAR_WIDGET_VOLUME_H
#define KBAR_WIDGET_VOLUME_H
...
#define KBAR_TYPE_WIDGET_VOLUME (kbar_widget_volume_get_type())
G_DECLARE_FINAL_TYPE(KBarWidgetVolume, kbar_widget_volume, KBAR, WIDGET_VOLUME, KBarWidget)
