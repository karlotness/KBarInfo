...
#ifndef KBAR_WIDGET_NETWORK_H
#define KBAR_WIDGET_NETWORK_H
...
#define KBAR_TYPE_WIDGET_NETWORK (kbar_widget_network_get_type())
G_DECLARE_FINAL_TYPE(KBarWidgetNetwork, kbar_widget_network, KBAR, WIDGET_NETWORK, KBarWidget)
