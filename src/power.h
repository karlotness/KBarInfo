...
#ifndef KBAR_WIDGET_POWER_H
#define KBAR_WIDGET_POWER_H
...
#define KBAR_TYPE_WIDGET_POWER (kbar_widget_power_get_type())
G_DECLARE_FINAL_TYPE(KBarWidgetPower, kbar_widget_power, KBAR, WIDGET_POWER, KBarWidget)
